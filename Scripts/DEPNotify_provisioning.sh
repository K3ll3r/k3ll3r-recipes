...
# Service branding, please see the Customized Self Service Branding area below
  BANNER_IMAGE_PATH="/Library/Application Support/JAMF/bin/cruise_logo.png"
...
# Update the variable below replacing "email helpdesk@company.com" with the actual plaintext instructions for your organization. Example "call 555-1212" or "email helpdesk@company.com"
  SUPPORT_CONTACT_DETAILS="slack @pITbot or create a ticket at go/helpdesk"
...
# quotes below as double quotes will break the new lines.
  MAIN_TEXT='Glad to have you on the team! We want you to have a few applications and settings configured before you get started with your new Mac. This process should take 10 to 20 minutes to complete. \n \n If you need to add printers or install additional software, please use the Self Service app which is located in your Applications folder and on your Dock. \n \n If you need anything else, just '$SUPPORT_CONTACT_DETAILS''
...
# If this variable is left blank, the generic message will appear. Leave single
# quotes below as double quotes will break the new lines.
	ERROR_MAIN_TEXT="We are sorry that you are experiencing this inconvenience with your new Mac. Don't worry, we'll get you back up and running in no time!
...
# run in order as they appear below.
  POLICY_ARRAY=(
    "Updating your user information,update_user_info_login"
	"Installing Python,install_python"
    "Installing Slack,install_Slack"
    "Installing Cruise Logo files,cruise_logo"
	"Enabling macOS Updates,macOS_update_settings"
    "Applying Cruise Wallpaper,cruise_wallpaper_dark"
    "Installing our Device Health app,install_Duo Device Health"
    "Installing Google Chrome,install_Google Chrome"
	"Setting Chrome as the default browser,set_browser_chrome"
    "Installing the VPN,cisco_any_connect"
    "Installing Zoom,install_Zoom"
	"Adding Self Service to your dock,self_service_dock"
	"Cleaning up setup files,kickstart_cleanup"
    "Deploying User Certificate,wait_for_config"
  )
...
echo "Provisioning took $runtime seconds to complete"
